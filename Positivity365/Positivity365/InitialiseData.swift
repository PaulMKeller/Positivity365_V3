...
class InitialiseData{
    ...
    class func checkForData() {
        if checkYears() == false {
            ...
            createMonths(newMonthGroup: "January", newMaxDay: 31)
            createMonths(newMonthGroup: "February", newMaxDay: 29)
            createMonths(newMonthGroup: "March", newMaxDay: 31)
            createMonths(newMonthGroup: "April", newMaxDay: 30)
            createMonths(newMonthGroup: "May", newMaxDay: 31)
            createMonths(newMonthGroup: "June", newMaxDay: 30)
            createMonths(newMonthGroup: "July", newMaxDay: 31)
            createMonths(newMonthGroup: "August", newMaxDay: 31)
            createMonths(newMonthGroup: "September", newMaxDay: 30)
            createMonths(newMonthGroup: "October", newMaxDay: 31)
            createMonths(newMonthGroup: "November", newMaxDay: 30)
            createMonths(newMonthGroup: "December", newMaxDay: 31)
    ...
    class func createYears(newYearGroup: String, newLeapYear: Bool) {
    ...
    class func createMonths(newMonthGroup: String, newMaxDay: Int16) {
    ...
    class func createDays(newDay: Int16) {
